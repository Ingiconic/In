...
const BottomNav = () => {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 safe-area-pb">
      ...
      <div className="bg-background/70 backdrop-blur-xl border-t border-border/20">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center gap-1 px-2 py-1.5 rounded-xl transition-all duration-300 min-w-[60px] ${
                  active
                    ? "text-primary"
